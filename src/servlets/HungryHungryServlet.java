	        ...
	        // jsoup test
	                try {
	                    ...
	                    while (iter.hasNext()) {
	                        ...
	                        if (title.contains("Food") || title.contains("Dine") || title.contains("Lunch") || title.contains("Freeze") || title.contains("Tea") || title.contains("TGIF") || title.contains("Tailgate")){
	                        	arr.add(title);
		                        System.out.println(title);
		                        arr.add("" + e.select(".view-data-node-data-field-cal-location-field-cal-location-value").html());
		                        arr.add("" + e.select(".date-display-start").html() + " - " +e.select(".date-display-end").html());
		                        map.put(i, arr);
		                        i ++;
	                        }
